...
- June 26, 2025. Updated V1.3.3 - Re-enabled Brevo integration and manually synced all 33 users to email list #15 (confirmed working, list now contains all registered users)
```
