...
export default function RecruitmentEn({ locale = 'en' }: RecruitmentProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, this is our commitment to the 300 founding members. Future platform access will be annual subscription-based, only founding members enjoy this privilege."
    },
    {
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-blue-600 font-semibold mb-8">
            This isn't another theory course - we're giving you a proven system to boost your ROAS.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">
            Instead of Another Theory Set, We Give You a Complete "Battle System"
          </h2>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8 mb-12">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              We understand advertisers' pain points. So this time, we're not doing empty theoretical teaching. Through a <strong>2.5-hour live workshop</strong>, we'll directly guide you through our SaaS platform "Report Data" - built with thousands of hours and hundreds of iterations, specifically for e-commerce advertisers.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="relative overflow-hidden border-2 border-orange-200 hover:border-orange-400 transition-all">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Besides live workshop, you'll get our complete pre-recorded online course. As your permanent learning backup, allowing you to review and dive deeper into every advertising detail.
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 line-through">
                  Price: $59
                </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold mb-12">
            Become Our Founding Member with One-Time Investment
          </h2>
